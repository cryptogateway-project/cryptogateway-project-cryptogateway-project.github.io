...
1. Connectez-vous à votre compte sur [](https://pay.izichange.com/login).
...
![image du dashboard generation pour la génération de clé api izichangepay](/cryptogateway-project/assets/images/key1.png?width=300&height=200)

4. Copiez la clé générée en lieu sûr.

![image du dashboard generation pour la génération de clé api izichangepay](/cryptogateway-project/assets/images/key4.png?width=300&height=200)
